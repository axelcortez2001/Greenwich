...
<nav class="flex items-center justify-between p-4 fixed-navbar">
    ...
    <ul class="flex space-x-4">
        ...
        <?php if ($user['job_name'] === 'Admin' || $user['job_name'] === 'Manager') : ?>
            <li><a href="<?php echo site_url('Analytics/Analytics'); ?>" class="text-white hover:text-gray-400 text-lg <?php echo ($this->uri->segment(1) == 'Analytics' ? 'active-link' : ''); ?>">Analytics</a></li>
        <?php endif; ?>
